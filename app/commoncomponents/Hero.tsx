...
export default function Carousel() {
  ...
  return (
    ...
    >
      ...
      <Button
        className="absolute left-4 top-1/2 -translate-y-1/2 p-2 md:p-3 bg-black/50 text-white hover:bg-black/70 hidden md:block"
        onClick={prevSlide}
      >
        <ChevronLeft size={25} />
      </Button>
      ...
      <Button
        className="absolute right-4 top-1/2 -translate-y-1/2 p-2 md:p-3 bg-black/50 text-white hover:bg-black/70 hidden md:block"
        onClick={nextSlide}
      >
        <ChevronRight size={25} />
      </Button>
